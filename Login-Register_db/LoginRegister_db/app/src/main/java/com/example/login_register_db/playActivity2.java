...
public class playActivity2 extends AppCompatActivity {
    ...
    String[] choose_list = {
            ...
            "Αίγαγρος της\nΕρημομήλου","Κρι-Κρι","Γίδια","Καλαρρύτικο\n αρνί",
            "Φασκόμηλο","θυμάρι","Λεβάντα","Όλα τα \nπαραπάνω"
    };
    String[] correct_list = {
            "Λία",
            "Τον γεωλογικό\n χαρακτήρα",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_flipper2);

        viewFlipper  = findViewById(R.id.viewFlipper2); // Initialize viewFlipper first
        View explanationView = getLayoutInflater().inflate(R.layout.explanation_quizz2, viewFlipper, false);
        viewFlipper.addView(explanationView);

        txtcorrectanswe = findViewById(R.id.txtcorrectanwser2);
        txtanswer = findViewById(R.id.txtanswer2);
        txtanswedeccription = findViewById(R.id.txtanswerdescription2);
